...
function saleHotdogs(n){
    return n < 5 ? 100 * n : n >=5 && n < 10 ? 95 
    * n : 90 * n
}

// key learning objective, you can chain ifelses with the ternary operator also
// test ? value if true : if false run test 2 ? value if test2 is true : if false run test 3 ? value if test3 is true : value if test3 is false